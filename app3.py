...
#         def get_coords(city):
#             res = requests.get(geo_url, params={"text": city + " India", "apiKey": GEOAPIFY_API_KEY}, timeout=10).json()
#             if not res.get("features"):
#                 return None
#             p = res["features"][0]["properties"]
#             return p["lon"], p["lat"]
...
#         if not start or not end:
#             print(f"Could not geocode: {source} or {destination}")
#             return []
...
#             print("No route features returned")
#             return []
...
#         # Sample 8 evenly spaced points along the route
#         total   = len(flat)
...
#                 places.append({
#                     "title":   name,
#                     "address": prop.get("formatted", prop.get("address_line2", "")),
#                     "image":   image_url
#                 })
...
#         print(f"Found {len(places)} route places")
#         return places[:10]

#     except Exception as e:
#         print(f"Route places error: {e}")
#         import traceback
#         traceback.print_exc()
#         return []
